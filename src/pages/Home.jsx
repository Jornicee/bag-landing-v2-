    ...
    <>
      ...
      <main id="home">
        <article className={styles.mainContainer}>
          ...
          <a href="#contatos" onClick={handleWhatsAppClick}>
            <WhatsappLogoIcon size={32} aria-hidden="true" />
            <span>FALE CONOSCO</span>
          </a>
        </article>
        <aside className={styles.imageSection} aria-label="Imagens ilustrativas da YellowBagEdu">
          <img src={Img01} alt="" aria-hidden="true" />
          <img src={Img02} alt="" aria-hidden="true" />
        </aside>
      </main>
    </>
  );
